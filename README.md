...
![Up
      ...
      >
        <title id="titleId">Juan Daniel Duarte's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2025 : 4, Total PRs: 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 250.8654271128702;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Juan Daniel Duarte's GitHub Stats</text>
    </g>
      </g>
...
![U
    ...
    <text x="0" y="11" class="stat bold" fill="#a9fef7">No languages data.</text>
...
</div><p align="center"> <img src="https://komarev.com/ghpvc/?username=JUANDANIEL1470&label=Profile%20views&color=0e75b6&style=flat" alt="Visitas al perfil" /> </p>
